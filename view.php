                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Hi, Selamat Datang di Menu Pesanan!</li>
                        </ol>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-body">
                                ...
                                <?php
                                $getproduk = mysqli_query($koneksi, "select * from produk where idproduk not in (select idproduk from detail where idpesanan='$idp')");
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php
                                    $get = mysqli_query($koneksi,"select * from detail p, produk pr where p.idproduk=pr.idproduk and idpesanan='$idp'");
                                    $i = 1;
                                    ...
                                    ?>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                                                <button type="submit" class="btn btn-success" name="hapusprodukpesanan">Yes</button>
                                            </div>
